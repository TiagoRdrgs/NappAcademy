...
class TestAbstracaoERP1TXT(unittest.TestCase):
    def setUp(self):
...
class TestAbstracaoERP1CSV(unittest.TestCase):
    def setUp(self):
        self.dicionario = {'erp': 'erp1',
                           'db': 'integrador/dados/banco_ERP1.db',
                           'relatorio': 'csv'}
...
class TestAbstracaoERP2TXT(unittest.TestCase):
    def setUp(self):
...
class TestAbstracaoERP2CSV(unittest.TestCase):
    def setUp(self):
        self.dicionario = {'erp': 'erp2',
                           'db': 'integrador/dados/banco_ERP2.db',
                           'relatorio': 'csv'}
